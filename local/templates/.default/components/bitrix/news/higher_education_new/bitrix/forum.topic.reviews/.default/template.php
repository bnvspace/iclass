                ...
                <div class="reviews-block-inner">
                    <?
                        ...
                        <table cellspacing="0" border="0"
                               class="reviews-post-table <?=($iCount == 1 ? "reviews-post-first " : "")?><?
                               ...
                               ?>" bx-author-id="<?=$res["AUTHOR_ID"]?>" bx-author-name="<?=$res["AUTHOR_NAME"]?>"
                               id="message<?=$res["ID"]?>">
                            <thead>
                            <tr>
                                <td>
                                        ...
                                        if ($arParams["SHOW_AVATAR"] != "N") {
                                            ...
                                            <div class="review-avatar"><?
                                                    if (is_array($res["AVATAR"]) &&
                                                        array_key_exists("HTML", $res["AVATAR"])
                                                    ): ?><?=$res["AVATAR"]["HTML"]?><?
                                                    else: ?><img
                                                            src="/bitrix/components/bitrix/forum.topic.reviews/templates/.default/images/noavatar.gif"
                                                            border="0"/><? endif;
                                                ?></div>
                                            <?
                                        }
                                            ...
                                            <div class="review-rating rating_vote_graphic">
                                                <?
                                                    ...
                                                    $APPLICATION->IncludeComponent("bitrix:rating.vote",
                                                        $arParams["RATING_TYPE"], $arRatingParams, $component,
                                                        array("HIDE_ICONS" => "Y"));
                                                ?>
                                            </div>
                                            <?
                                            ...
                                            <div class="reviews-post-reply-buttons">
                                                <noindex>
                                                    <a href="#review_anchor" style='margin-left:0;'
                                                       title="<?=GetMessage("F_NAME")?>" class="reviews-button-small"
                                                    ...
                                                    <? if ($arResult["FORUM"]["ALLOW_QUOTE"] == "Y") {
                                                        ...
                                                        <a href="#review_anchor" title="<?=GetMessage("F_QUOTE_HINT")?>"
                                                           ...
                                                           bx-act="quote"><?=GetMessage("F_QUOTE_FULL")?></a><?
                                                    }
                                                        ...
                                                        if ($arParams["SHOW_RATING"] == "Y") {
                                                            ...
                                                            $arRatingParams = array_merge($arRatingParams,
                                                                $res['RATING']);
